...
public class Main {
    ...
    private static boolean displayCompanyLogo() {
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\\\Users\\\\Naresh\\\\OneDrive\\\\Desktop\\\\MajorProject\\\\Logo.txt"))) {
            String line;
        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    System.out.println("Thanks for using Book My Bus");
                    running = false;
                    break;
                default:
